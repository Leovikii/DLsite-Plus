...
- **点击预览卡片**：在南+论坛，只需点击任何 RJ 号，即可弹出一个极具现代毛玻璃（Glassmorphism）质感的精致卡片，直观展示 DLsite 封面、标题、社团、标签、声优以及销量等详尽信息。
...
- **方式 A：通过 GreasyFork 安装（推荐）**
  点击 **[此处](https://greasyfork.org/zh-CN/scripts/583340-rj-warp-gate)** 安装，支持后续自动更新。
